...
const Quotation = () => {
  ...
  const handleQuotationSubmit = async (totals) => {
    ...
    const dataToExport = newQuotations.map((q, i) => ({
      ...
      additionalitemsalexaQuantity: q.additionalalexaQty,
      additionalitemsalexaUnitPrice: q.additionalalexaPrice,
      totalAdditionalitemsalexa: q.totalAdditionalalexa,

      blindsblindTrackUnitPrice: q.blindstrackPrice,
      blindsblindTrackQuantity: q.blindstrackQty,
      totalBlindsCost: q.totalBlindstrack,

      blindsblindMotorUnitPrice: q.blindsmotorPrice,
      blindsblindMotorQuantity: q.blindsmotorQty,
      totalBlindsblindMotor: q.totalBlindsmotor,

      additionalitemslightEngineRgbColourTwinkleEffectQuantity: q.additionallightQty,
      additionalitemslightEngineRgbColourTwinkleEffectUnitPrice: q.additionallightPrice,
      totalAdditionalitemslightEngineRgbColourTwinkleEffect: q.totalAdditionallight,

      additionalitemsstarPointRatio75mm501mm3015mmQuantity: q.additionalstarQty,
      additionalitemsstarPointRatio75mm501mm3015mmUnitPrice: q.
      additionalstarPrice,
      totalAdditionalitemsstarPointRatio75mm501mm3015mm: q.totalAdditionalstar,


      cablessubwooferCable5mUnitPrice: q.cablessubwooferPrice,
      cablessubwooferCable5mQuantity: q.cablessubwooferQty,
      totalCablessubwooferCable5m: q.totalCablessubwoofer,

      cableshdmiCable10mQuantity: q.cableshdmiQty,
      cableshdmiCable10mUnitPrice: q.cableshdmiPrice,
      totalCableshdmiCable10m: q.totalCableshdmi,

      cablesspeakerCable90mQuantity: q.cablesspeakerQty,
      cablesspeakerCable90mUnitPrice: q.cablesspeakerPrice,
      totalCablesspeakerCable90m: q.totalCablesspeaker,

      curtainscurtainMotorUnitPrice: q.curtainsmotorPrice,
      curtainscurtainMotorQuantity: q.curtainsmotorQty,
      totalCurtainscurtainMotor: q.totalCurtainsmotor,

      curtainscurtainTrackUnitPrice: q.curtainstrackPrice,
      curtainscurtainTrackQuantity: q.curtainstrackQty,
      totalCurtainscurtainTrack: q.totalCurtainstrack,

      driversrgbLedStripControllerQuantity: q.driversrgbQty,
      driversrgbLedStripControllerUnitPrice: q.driversrgbPrice,
      totalDriversrgbLedStripController: q.totalDriversrgb,

      driverstunableDimmableLedDriverQuantity: q.driverstunableQty,
      driverstunableDimmableLedDriverUnitPrice: q.driverstunablePrice,
      totalDriverstunableDimmableLedDriver: q.totalDriverstunable,

      gateautomationsystemgateAutomationMotorOneSideOpeningQuantity: q.
      gategateQty,
      gateautomationsystemgateAutomationMotorOneSideOpeningUnitPrice: q.gategatePrice,
      totalGateautomationsystemgateAutomationMotorOneSideOpening: q.totalGategate,


      lightingmotionSensorQuantity: q.lightingmotionQty,
      lightingmotionSensorUnitPrice: q.lightingmotionPrice,
      totalLightingmotionSensor: q.totalLightingmotion,

      "networking&cctv4mpBulletCamHikvisionColourQuantity": q.networking4mpQty,
      "networking&cctv4mpBulletCamHikvisionColourUnitPrice": q.networking4mpPrice,
      "totalNetworking&cctv4mpBulletCamHikvisionColour": q.totalNetworking4mp,

      "networking&cctv6mpPanoramicColorvuBulletCamQuantity": q.networking6mpQty,
      "networking&cctv6mpPanoramicColorvuBulletCamUnitPrice": q.networking6mpPrice,
      "totalNetworking&cctv6mpPanoramicColorvuBulletCam": q.totalNetworking6mp,

      "networking&cctv16PortPoeHikvisionQuantity": q.networking16Qty,
      "networking&cctv16PortPoeHikvisionUnitPrice": q.networking16Price,
      "totalNetworking&cctv16PortPoeHikvision": q.totalNetworking16,

      "networking&cctvaccessPointTpLinkQuantity": q.networkingaccessQty,
      "networking&cctvaccessPointTpLinkUnitPrice": q.networkingaccessPrice,
      "totalNetworking&cctvaccessPointTpLink": q.totalNetworkingaccess,

      "networking&cctvrj45ConnectorsQuantity": q.networkingrj45Qty,
      "networking&cctvrj45ConnectorsUnitPrice": q.networkingrj45Price,
      "totalNetworking&cctvrj45Connectors": q.totalNetworkingrj45,

      "networking&cctvhardDisk2tbQuantity": q.networkinghardQty,
      "networking&cctvhardDisk2tbUnitPrice": q.networkinghardPrice,
      "totalNetworking&cctvhardDisk2tb": q.totalNetworkinghard,

      "networking&cctvpvcBoxesQuantity": q.networkingpvcQty,
      "networking&cctvpvcBoxesUnitPrice": q.networkingpvcPrice,
      "totalNetworking&cctvpvcBoxes": q.totalNetworkingpvc,

      "networking&cctvnvrHikvision16ChannelUnitPrice": q.networkingnvrQty,
      "networking&cctvnvrHikvision16ChannelQuantity": q.networkingnvrPrice,
      "totalNetworking&cctvnvrHikvision16Channel": q.totalNetworkingnvr,

      vdpdoorsystemvdpDoorSystemQuantity: q.vdpvdpQty,
      vdpdoorsystemvdpDoorSystemUnitPrice: q.vdpvdpPrice,
      totalVdpdoorsystemvdpDoorSystem: q.totalVdpvdp,

      totallightingCost: q.totallightingCost,
      totalblindsCost: q.totalblindsCost,
      totalCurtainsCost: q.totalcurtainsCost,
      totalvdpCost: q.totalvdpCost,
      totalGateAutomationSystemCost: q.totalgateCost,
      totalDriversCost: q.totaldriversCost,
      totalnetworkingCost: q.totalnetworkingCost,
      totalCablesCost: q.totalcablesCost,
      totalAdditionalItemsCost: q.
      totaladditionalCost,
    ...
    // console.log("Only one client Data in object: ", updatedData); //this will display one quotation in an object
    try {
      const response = await communication.createQuotation(updatedData);
      if (response?.data?.status === "SUCCESS") {
        toast.success('Quotaion added successfully');
      }
    } catch (error) {
  ...
  const showQuotations = async ()=>{
    try {
      const response = await communication.getQuotationList("","");
      if (response?.data.result) {
        toast.success('Successfully showing Quotations');
        console.log(response.data.result);
        setShowQuotation(response.data.result);
      }
      else{
        console.log("in else part showQuotations")
      }
    } catch (error) {
      console.error("Failed to fetch project list:", error);
    }
      ...
      {ShowEntryQuotation ? (
        <div className="quotation-wrapper">
          <div className='topButtons'>
            <button onClick={() => setShowEntryQuotation(false)} className='submit'>Show All Quotation</button>
            <NavLink to="/pquotation" className="nav-link">
              <button className='submit'> + Add Easy Quotation</button>
            </NavLink>
          ...
          <div className="quotation-container" ref={quotationRef}>
            ...
            {/* second table */}
            <br />
            <Qproducts onSubmit={handleQuotationSubmit} totalProjectCost={totalProjectCost} />
            {/* <p style={{ textAlign: "left", padding: "20px" }} className="QuotationTotal">
        ...
        <>
          <div className="quotation-wrapper">
            <div className="showQuotationsHeading">
              <button onClick={() => setShowEntryQuotation(true)} className='submit'>Add New Quotation</button>
                ...
                <tbody>
                  ...
                  {showQuotation.map((q) => (
                    ...
                    >
                      ...
                      <td>{q.isActive}</td>
                      <td>
                        <button onClick={() => handleEdit(q._id)} className="action-btn edit">
